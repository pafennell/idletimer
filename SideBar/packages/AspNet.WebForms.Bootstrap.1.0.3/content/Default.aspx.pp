<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="$rootnamespace$.Default" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="BodyContent" runat="server">
	...
	<div class="jumbotron">
		...
		<p><a href="http://getbootstrap.com/" class="btn btn-primary btn-lg" role="button">Learn more &raquo;</a></p>
	</div>
